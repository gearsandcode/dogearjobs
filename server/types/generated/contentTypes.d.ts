...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    range: Schema.Attribute.Enumeration<
      [
        'Any time',
        'Past hour',
        'Past 24 hours',
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Past week'>;
    tags: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'>;
    term_sets: Schema.Attribute.Component<'search.term-sets', true>;
    Terms: Schema.Attribute.Component<'search.terms', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTermTerm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    term: Schema.Attribute.String & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
